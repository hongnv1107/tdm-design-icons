...
const bHCircleSvg = (
  ...
  >
    ...
    <path fill="#D80027" d="M12 0C9.592 0 7.35.709 5.47 1.93L8.557 4 4.696 6l3.86 2-3.86 2 3.86 2-3.86 2 3.86 2-3.86 2 3.86 2-3.086 2.069A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0Z"/>
    </g>
    <defs>
    <clipPath id="a">
