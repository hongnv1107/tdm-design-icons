...
const yECircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#000" d="M12 24c5.16 0 9.558-3.257 11.254-7.827H.746C2.442 20.743 6.84 24 12 24Z"/><path fill="#D80027" d="M12 0C6.84 0 2.442 3.257.746 7.827h22.508C21.558 3.257 17.16 0 12 0Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
