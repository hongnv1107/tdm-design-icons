...
const tGCircleSvg = (
  ...
  >
    ...
    <path fill="#496E2D" d="M12 0c-.009 0-.522 4.8-.522 4.8h10.123A11.982 11.982 0 0 0 12 0Zm0 24c3.926 0 7.411-1.885 9.6-4.8H2.4A11.98 11.98 0 0 0 12 24ZM23.76 9.6H11.478L12 14.4h11.76a12.05 12.05 0 0 0 0-4.8Z"/>
    <path fill="#D80027" d="M12 14.4V0C5.373 0 0 5.373 0 12c0 .822.083 1.624.24 2.4H12Z"/>
    <path fill="#F0F0F0" d="m6.621 5.738.777 2.392h2.515L7.878 9.608l.777 2.391-2.034-1.478L4.587 12l.777-2.391L3.33 8.13h2.514l.777-2.392Z"/>
    </g>
    <defs>
    <clipPath id="a">
