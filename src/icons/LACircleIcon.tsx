...
const lACircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#D80027" d="M22.81 6.782A12 12 0 0 0 12-.001 12 12 0 0 0 1.19 6.782L12 7.825l10.81-1.043ZM1.19 17.216A12 12 0 0 0 12 24a12 12 0 0 0 10.809-6.783l-10.81-1.043L1.19 17.216Z"/><path fill="#0052B4" d="M22.81 6.782H1.19A11.952 11.952 0 0 0 0 11.999c0 1.87.427 3.64 1.19 5.217h21.62A11.95 11.95 0 0 0 23.999 12c0-1.87-.427-3.64-1.19-5.217Z"/><path fill="#F0F0F0" d="M12 16.173a4.173 4.173 0 1 0 0-8.347 4.173 4.173 0 0 0 0 8.347Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
