...
const sLCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M23.254 16.174c.482-1.3.746-2.706.746-4.174 0-1.467-.264-2.874-.746-4.173L12 6.783.746 7.827A11.973 11.973 0 0 0 0 12c0 1.468.264 2.874.746 4.174L12 17.218l11.254-1.044Z"/><path fill="#338AF3" d="M12 24c5.16 0 9.558-3.256 11.254-7.826H.746C2.442 20.744 6.84 24.001 12 24.001Z"/><path fill="#6DA544" d="M12 0C6.84 0 2.442 3.257.746 7.827h22.508C21.558 3.257 17.16 0 12 0Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
