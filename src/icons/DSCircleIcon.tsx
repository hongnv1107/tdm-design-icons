...
const dSCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#F0F0F0" d="M1.191 6.783A11.952 11.952 0 0 0 .001 12c0 1.87.427 3.64 1.19 5.217l10.81 1.044 10.809-1.044A11.953 11.953 0 0 0 24 12c0-1.87-.427-3.64-1.19-5.217L12 5.739 1.192 6.783Z"/>
    <path fill="#000" d="M1.191 17.217A12 12 0 0 0 12 24a12 12 0 0 0 10.809-6.782H1.19Z"/>
    <path fill="#D80027" d="M1.191 6.783H22.81A12 12 0 0 0 11.999 0 12 12 0 0 0 1.192 6.783Z"/>
    <path fill="#496E2D" d="M3.515 3.514c-4.686 4.686-4.686 12.284 0 16.97L12.001 12 3.514 3.514Z"/>
    </g>
    <defs>
    <clipPath id="a">
