...
const pACircleSvg = (
  ...
  >
    ...
    <path fill="#0052B4" d="M0 12c0 6.627 5.373 12 12 12V12H0Z"/>
    <path fill="#D80027" d="M12 0c6.627 0 12 5.373 12 12H12V0Z"/>
    <path fill="#0052B4" d="m7.144 4.175.777 2.391h2.514L8.401 8.044l.777 2.392-2.034-1.478-2.035 1.478.777-2.392-2.034-1.478h2.515l.777-2.391Z"/>
    <path fill="#D80027" d="m16.857 13.565.777 2.391h2.515l-2.035 1.478.777 2.392-2.034-1.478-2.034 1.478.777-2.392-2.034-1.478h2.514l.777-2.391Z"/>
    </g>
    <defs>
    <clipPath id="a">
