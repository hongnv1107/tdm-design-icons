...
const cZCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#D80027" d="M10.957 12s-7.435 8.486-7.442 8.485A11.962 11.962 0 0 0 12 24c6.627 0 12-5.373 12-12H10.957Z"/><path fill="#0052B4" d="M3.515 3.515c-4.686 4.686-4.686 12.283 0 16.97L12.001 12 3.514 3.515Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
