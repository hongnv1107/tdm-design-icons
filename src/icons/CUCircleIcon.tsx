...
const cUCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#FF9811" d="M0 2.087v19.826V2.087Z"/><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.372 12-12 0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12Z"/><path fill="#0052B4" d="M12 0a11.982 11.982 0 0 0-9.601 4.8h19.2A11.98 11.98 0 0 0 12 0Zm0 24a11.98 11.98 0 0 0 9.6-4.8H2.399a11.982 11.982 0 0 0 9.6 4.8ZM0 12c0 .822.083 1.625.24 2.4h23.52a12.05 12.05 0 0 0 0-4.8H.24C.083 10.376 0 11.178 0 12Z"/><path fill="#D80027" d="M3.515 3.515c-4.687 4.686-4.687 12.284 0 16.97L12 12 3.515 3.515Z"/><path fill="#F0F0F0" d="m4.856 8.87.777 2.39h2.515l-2.034 1.48.777 2.391-2.035-1.478-2.034 1.478.777-2.391-2.034-1.478h2.514l.777-2.391Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
