...
const lTCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#6DA544" d="M23.254 16.174c.482-1.3.746-2.706.746-4.174a11.98 11.98 0 0 0-.746-4.173L12 6.783.748 7.827A11.973 11.973 0 0 0 0 12c0 1.468.264 2.874.747 4.174L12 17.218l11.253-1.044Z"/>
    <path fill="#FFDA44" d="M23.254 7.827C21.56 3.257 17.16 0 12 0 6.84 0 2.442 3.257.747 7.827h22.507Z"/>
    <path fill="#D80027" d="M12 24c5.16 0 9.559-3.256 11.254-7.826H.747C2.442 20.744 6.84 24.001 12 24.001Z"/>
    </g>
    <defs>
    <clipPath id="a">
