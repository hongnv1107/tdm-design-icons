...
const bWCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#F0F0F0" d="M.567 8.348A11.99 11.99 0 0 0 0 12c0 1.274.2 2.5.567 3.652l11.434.522 11.433-.522C23.8 14.5 24 13.274 24 12s-.199-2.5-.566-3.652L12 7.826.567 8.348Z"/>
    <path fill="#000" d="M24 12c0-.712-.062-1.409-.18-2.086H.181a12.057 12.057 0 0 0 0 4.174h23.637c.12-.678.182-1.376.182-2.088Z"/>
    <path fill="#338AF3" d="M12 24c5.354 0 9.889-3.506 11.434-8.348H.567C2.112 20.494 6.647 24 12 24Zm0-24C6.647 0 2.112 3.505.567 8.347h22.867C21.889 3.506 17.354-.001 12-.001Z"/>
    </g>
    <defs>
    <clipPath id="a">
