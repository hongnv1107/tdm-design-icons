...
const dJCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#338AF3" d="M10.956 13.044s-7.435-9.53-7.442-9.529A11.962 11.962 0 0 1 12 .001c6.627 0 12 5.372 12 12l-13.044 1.043Z"/><path fill="#6DA544" d="M10.956 12s-7.435 8.486-7.442 8.485A11.962 11.962 0 0 0 12 23.999c6.627 0 12-5.372 12-12H10.956Z"/><path fill="#F0F0F0" d="M3.514 3.515c-4.686 4.687-4.686 12.283 0 16.97L12 12 3.513 3.515Z"/><path fill="#D80027" d="m4.856 8.87.777 2.39h2.515l-2.035 1.48.777 2.391-2.034-1.478-2.034 1.478.777-2.391-2.034-1.478h2.514l.777-2.392Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
