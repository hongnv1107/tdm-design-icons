...
const gMCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#A2001D" d="M12 0C7.039 0 2.782 3.011.954 7.305h22.093C21.219 3.011 16.96 0 12 0Z"/><path fill="#496E2D" d="M12 24c4.961 0 9.219-3.01 11.047-7.304H.954C2.782 20.99 7.04 24 12 24Z"/><path fill="#0052B4" d="M23.586 8.87H.413A12.013 12.013 0 0 0 0 12c0 1.083.144 2.132.413 3.13h23.174a12.053 12.053 0 0 0-.001-6.26Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
