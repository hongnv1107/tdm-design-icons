...
const iNCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#FF9811" d="M12 0A12 12 0 0 0 1.19 6.782h21.62A12 12 0 0 0 12 0Z"/><path fill="#6DA544" d="M12 24c4.758 0 8.868-2.769 10.81-6.783H1.19A12 12 0 0 0 12 24Z"/><path fill="#0052B4" d="M12 16.173a4.174 4.174 0 1 0 0-8.348 4.174 4.174 0 0 0 0 8.348Z"/><path fill="#F0F0F0" d="M12 14.608a2.609 2.609 0 1 0 0-5.217 2.609 2.609 0 0 0 0 5.217Z"/><path fill="#0052B4" d="m12 8.78.805 1.826 1.983-.216L13.61 12l1.178 1.61-1.983-.216L12 15.219l-.805-1.825-1.983.216L10.391 12l-1.179-1.61 1.983.216L12 8.781Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
