...
const hUCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M.746 7.825A11.975 11.975 0 0 0 0 12c0 1.468.264 2.874.746 4.174L12 17.217l11.253-1.044c.482-1.3.747-2.706.747-4.174 0-1.468-.265-2.874-.747-4.174L12 6.782.746 7.825Z"/><path fill="#D80027" d="M12-.001C6.84-.001 2.441 3.256.746 7.825h22.507C21.558 3.255 17.16 0 12 0Z"/><path fill="#6DA544" d="M12 24c5.16 0 9.558-3.257 11.253-7.827H.746C2.44 20.743 6.84 23.999 12 23.999Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
