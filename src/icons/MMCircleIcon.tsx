...
const mMCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#6DA544" d="M23.254 16.174c.482-1.3.746-2.706.746-4.173 0-1.468-.264-2.874-.746-4.174L12 6.783.746 7.827A11.974 11.974 0 0 0 0 12c0 1.467.264 2.873.746 4.173L12 17.218l11.254-1.044Z"/><path fill="#FFDA44" d="M23.254 7.827C21.558 3.257 17.16 0 12 0 6.84 0 2.442 3.257.746 7.827h22.508Z"/><path fill="#D80027" d="M12 24c5.16 0 9.558-3.257 11.254-7.827H.746C2.442 20.743 6.84 23.999 12 23.999Z"/><path fill="#F0F0F0" d="M20.23 10.153h-6.287l-1.942-5.979-1.943 5.979H3.772l5.085 3.695-1.942 5.979L12 16.174l5.085 3.653-1.942-5.98 5.085-3.694Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
