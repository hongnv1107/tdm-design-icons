...
const bOCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#FFDA44" d="M24 12a11.98 11.98 0 0 0-.746-4.173L12 7.305.746 7.827A11.973 11.973 0 0 0 0 12c0 1.468.264 2.874.746 4.174L12 16.696l11.254-.521c.482-1.3.746-2.707.746-4.174Z"/><path fill="#6DA544" d="M12 24c5.16 0 9.558-3.256 11.254-7.825H.746C2.442 20.745 6.84 24 12 24Z"/><path fill="#D80027" d="M.746 7.827h22.508C21.558 3.257 17.159 0 12 0 6.84 0 2.442 3.257.746 7.827Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
