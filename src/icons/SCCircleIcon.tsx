...
const sCCircleSvg = (
  ...
  >
    ...
    <path fill="#FFDA44" d="M20.1 3.146A11.955 11.955 0 0 0 12 0c-.511 0-1.015.032-1.51.094L4.696 6.782.38 15.006a11.925 11.925 0 0 0 1.256 3.043L12 11.998l8.1-8.853Z"/>
    <path fill="#6DA544" d="m21.99 18.648-16.789 3.24A11.944 11.944 0 0 0 12 24c4.168 0 7.84-2.126 9.99-5.352Z"/>
    <path fill="#D80027" d="M20.102 3.148 1.642 18.06a12.045 12.045 0 0 0 1.72 2.268L24 12c0-3.504-1.502-6.658-3.898-8.852Z"/>
    <path fill="#0052B4" d="M0 12a12 12 0 0 0 .38 3.005L10.49.095C4.577.836 0 5.884 0 12Z"/>
    </g>
    <defs>
    <clipPath id="a">
