...
const bSCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#FFDA44" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0C5.372 0 0 5.373 0 12s5.372 12 12 12Z"/>
    <path fill="#338AF3" d="M7.305 7.825h15.95C21.559 3.255 17.16 0 12 0a11.96 11.96 0 0 0-8.485 3.515l3.79 4.311Zm-.001 8.347h15.95C21.558 20.742 17.16 24 12 24a11.961 11.961 0 0 1-8.485-3.515l3.79-4.312Z"/>
    <path fill="#000" d="M3.514 3.514c-4.686 4.687-4.686 12.285 0 16.97L12 12 3.513 3.514Z"/>
    </g>
    <defs>
    <clipPath id="a">
