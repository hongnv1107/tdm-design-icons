...
const jECircleSvg = (
  ...
  >
    ...
    <path fill="#D80027" d="m21.52 19.307-7.306-7.306 7.306-7.307a12.115 12.115 0 0 0-2.213-2.214L12 9.787 4.694 2.48A12.114 12.114 0 0 0 2.48 4.694L9.787 12 2.48 19.307a12.122 12.122 0 0 0 2.214 2.214L12 14.214l7.307 7.307a12.11 12.11 0 0 0 2.213-2.214Z"/>
    <path fill="#FFDA44" d="M9.913 3.653 12 4.175l2.086-.522V1.879l-.834.417L12 1.044l-1.253 1.252-.834-.417v1.774Z"/>
    <path fill="#D80027" d="M9.913 3.653v1.304C9.913 6.555 12 7.044 12 7.044s2.086-.49 2.086-2.087V3.653H9.913Z"/>
    </g>
    <defs>
    <clipPath id="a">
