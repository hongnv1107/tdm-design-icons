...
const zMCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#496E2D" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#D80027" d="M16.695 12H12v12c1.403 0 2.748-.242 4-.684l.695-11.317Z"/><path fill="#FF9811" d="M20 20.943A11.97 11.97 0 0 0 24 12h-4.695L20 20.942Z"/><path fill="#000" d="M16 12v11.316a11.995 11.995 0 0 0 4-2.373v-8.944h-4Z"/><path fill="#FF9811" d="M22.174 7.827h-3.13a1.044 1.044 0 0 0-2.087 0h-3.13c0 .576.501 1.043 1.077 1.043h-.034c0 .577.467 1.044 1.043 1.044 0 .576.467 1.043 1.044 1.043h2.087c.576 0 1.043-.467 1.043-1.043.576 0 1.044-.467 1.044-1.044h-.035c.576 0 1.078-.467 1.078-1.043Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
