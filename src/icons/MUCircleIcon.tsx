...
const mUCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#D80027" d="M1.458 6.26 12 7.304 22.54 6.26A11.997 11.997 0 0 0 12 0C7.45 0 3.493 2.53 1.457 6.26Z"/>
    <path fill="#FFDA44" d="m1.459 17.738 10.54 1.044 10.541-1.044C23.47 16.034 24 14.078 24 12l-12-1.043L0 12c0 2.08.528 4.035 1.459 5.74Z"/>
    <path fill="#0052B4" d="M1.458 6.26A11.946 11.946 0 0 0 0 12h24c0-2.08-.53-4.035-1.46-5.74H1.458Z"/>
    <path fill="#6DA544" d="M12 24c4.548 0 8.505-2.531 10.54-6.262H1.46A11.997 11.997 0 0 0 11.999 24Z"/>
    </g>
    <defs>
    <clipPath id="a">
