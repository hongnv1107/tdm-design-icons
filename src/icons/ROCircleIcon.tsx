...
const rOCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#FFDA44" d="M16.174.745A11.976 11.976 0 0 0 12 0c-1.468 0-2.874.264-4.174.746L6.783 12l1.043 11.254c1.3.482 2.706.746 4.174.746 1.468 0 2.874-.264 4.174-.746L17.217 12 16.174.745Z"/>
    <path fill="#D80027" d="M24 12c0-5.16-3.256-9.56-7.826-11.255v22.508C20.744 21.557 24 17.159 24 12Z"/>
    <path fill="#0052B4" d="M0 12c0 5.16 3.257 9.557 7.826 11.253V.745C3.256 2.441 0 6.84 0 12Z"/>
    </g>
    <defs>
    <clipPath id="a">
