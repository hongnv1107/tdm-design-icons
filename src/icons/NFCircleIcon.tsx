...
const nFCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#F0F0F0" d="M17.217 1.19A11.952 11.952 0 0 0 12 0c-1.87 0-3.64.428-5.218 1.19L5.74 12l1.043 10.809A11.951 11.951 0 0 0 12 23.999c1.87 0 3.64-.427 5.217-1.19l1.044-10.81L17.216 1.19Z"/>
    <path fill="#6DA544" d="M6.782 1.19A12 12 0 0 0 0 12a12 12 0 0 0 6.782 10.81V1.19Zm10.435 0v21.62A12 12 0 0 0 24 12c0-4.757-2.769-8.869-6.783-10.81ZM15.13 15.652 12 5.739l-3.13 9.913h2.348v2.608h1.565v-2.608h2.348Z"/>
    </g>
    <defs>
    <clipPath id="a">
