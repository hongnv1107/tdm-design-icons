...
const rUCircleSvg = (
  ...
  >
    ...
    <path fill="#0052B4" d="M23.254 16.173c.482-1.3.746-2.705.746-4.173s-.264-2.874-.746-4.174H.747A11.978 11.978 0 0 0 0 12c0 1.468.264 2.873.747 4.173L12 17.217l11.254-1.044Z"/>
    <path fill="#D80027" d="M12 24c5.16 0 9.558-3.257 11.254-7.827H.747C2.442 20.743 6.84 24 12 24Z"/>
    </g>
    <defs>
    <clipPath id="a">
