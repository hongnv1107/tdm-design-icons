...
const jMCircleSvg = (
  ...
  >
    ...
    <path fill="#6DA544" d="M19.306 2.48A11.946 11.946 0 0 0 12 0C9.25 0 6.718.925 4.694 2.48L12 9.788l7.306-7.306Z"/>
    <path fill="#000" d="M2.48 4.694A11.948 11.948 0 0 0 0 12c0 2.75.925 5.282 2.48 7.305L9.786 12 2.48 4.694Z"/>
    <path fill="#6DA544" d="M4.694 21.519A11.948 11.948 0 0 0 12 24c2.75 0 5.282-.926 7.306-2.481L12 14.213l-7.306 7.306Z"/>
    <path fill="#000" d="M21.52 19.305A11.944 11.944 0 0 0 24 12c0-2.75-.925-5.283-2.48-7.306l-7.306 7.305 7.305 7.306Z"/>
    </g>
    <defs>
    <clipPath id="a">
