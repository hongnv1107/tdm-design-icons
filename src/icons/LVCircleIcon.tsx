...
const lVCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#A2001D" d="M12 0C6.456 0 1.791 3.76.414 8.869h23.173C22.21 3.759 17.544 0 12 0Zm0 23.999c5.545 0 10.21-3.76 11.587-8.87H.414C1.79 20.24 6.456 24 12 24Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
