...
const pFCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#F0F0F0" d="M12 24c6.627 0 12-5.373 12-12S18.627 0 12 0 0 5.373 0 12s5.373 12 12 12Z"/><path fill="#D80027" d="M1.46 6.262h21.08A11.998 11.998 0 0 0 12 0 11.998 11.998 0 0 0 1.46 6.262ZM12 24c4.549 0 8.505-2.53 10.54-6.261H1.46A11.998 11.998 0 0 0 12 24Z"/><path fill="#FFDA44" d="M16.174 12c0 2.305-1.869 3.652-4.174 3.652-2.305 0-4.174-1.347-4.174-3.652a4.174 4.174 0 1 1 8.348 0Z"/><path fill="#0052B4" d="M16.174 12a4.174 4.174 0 1 1-8.348 0"/><path fill="#D80027" d="M10.435 10.956H9.392v2.087h1.043v-2.087Zm4.174 0h-1.044v2.087h1.044v-2.087ZM12.522 9.39h-1.043v3.653h1.043V9.391Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
