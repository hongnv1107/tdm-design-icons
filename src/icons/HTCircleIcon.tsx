...
const hTCircleSvg = (
  ...
  >
    <g clip-path="url(#a)"><path fill="#A2001D" d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 12 0 12 0s12 5.373 12 12Z"/><path fill="#0052B4" d="M0 12C0 5.373 5.373 0 12 0s12 5.373 12 12"/><path fill="#F0F0F0" d="M16.174 15.13 12 14.61l-4.174.521V8.87h8.348v6.26Z"/><path fill="#0052B4" d="M12 14.609a2.087 2.087 0 1 0-.001-4.175 2.087 2.087 0 0 0 0 4.175Z"/><path fill="#A2001D" d="M12 13.565a1.043 1.043 0 1 0 0-2.087 1.043 1.043 0 0 0 0 2.087Z"/><path fill="#6DA544" d="M10.435 9.913h3.13L12 11.478l-1.565-1.565Z"/><path fill="#FFDA44" d="M12.522 10.956H11.48v3.13h1.043v-3.13Z"/><path fill="#6DA544" d="M13.67 13.775h-3.34L7.826 15.13h8.348l-2.505-1.355Z"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h24v24H0z"/></clipPath></defs>
  </svg>
);
