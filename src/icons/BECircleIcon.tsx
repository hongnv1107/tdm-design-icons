...
const bECircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#FFDA44" d="M16.174.747A11.975 11.975 0 0 0 12 0a11.96 11.96 0 0 0-4.174.747L6.782 12l1.044 11.254c1.3.482 2.706.746 4.174.746 1.467 0 2.874-.264 4.174-.746L17.217 12 16.174.747Z"/>
    <path fill="#D80027" d="M24 12c0-5.16-3.257-9.558-7.826-11.253v22.507C20.744 21.558 24 17.159 24 11.999Z"/>
    <path fill="#000" d="M0 12c0 5.16 3.256 9.558 7.826 11.254V.747C3.256 2.442 0 6.84 0 12Z"/>
    </g>
    <defs>
    <clipPath id="a">
