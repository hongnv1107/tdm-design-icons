...
const tDCircleSvg = (
  ...
  >
    <g clip-path="url(#a)">
    <path fill="#FFDA44" d="M12 0c-1.467 0-2.874.263-4.173.746l-.522 11.253.521 11.254c1.3.482 2.707.747 4.174.747 1.468 0 2.874-.265 4.174-.747L16.696 12 16.174.746A11.975 11.975 0 0 0 12-.001Z"/>
    <path fill="#D80027" d="M24 12c0-5.16-3.256-9.559-7.826-11.254v22.507C20.744 21.558 24 17.16 24 12Z"/>
    <path fill="#0052B4" d="M7.826 23.253V.747C3.256 2.442 0 6.84 0 12s3.257 9.558 7.826 11.253Z"/>
    </g>
    <defs>
    <clipPath id="a">
